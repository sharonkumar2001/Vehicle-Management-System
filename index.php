    ...
    <div class="parallax foo">
       <?php include 'navbar.php';?>
        ...
        <div class="hero-text" style="font-size:50px text-align: center; position: absolute;top: 50%;left: 50%;transform: translate(-50%, -50%);color: white;">
            ...
            <h1 class="animated rubberBand" > SK Transport Management System</h1>
            <p>A management system where you can easily manage bookings </p>
    ...
    <div>
       <br><br>
        <div id="bus_route" class="container">
          ...
          <div class="row">
              <div class="col-md-6 foo">
                <p><b>The sk bus goes around the bangalore city in different interval. this is the route of the ruet bus.</b></p>
        ...
        <div id="driver" class="container">
          ...
          <div class="row">
              <div class="col-md-12">
                  <p style="font-size: 20px;">The driver of sk are very punctual and they provides great service. Every one of them is professional and great at their jobs</p>
        ...
        <div id="bus" class="container">
          ...
          <div class="row">
              ...
              <div class="col-md-6 foo1">
                  <p style="font-size:20px;"><b>In sk we have around ten buses and each one of it is well maintained. These buses goes in different direction of the city and can also be hired.</b></p>
              </div>
